...
func routes(r *web.Engine) *web.Engine {
	...
	collabAdmin := r.Group()
	{
		...
		collabAdmin.Put("/api/v1/sponsorship/campaigns/:id/assignments", apiv1.UpsertCampaignAssignment())
		collabAdmin.Delete("/api/v1/sponsorship/campaigns/:id/assignments/:placementId", apiv1.DeleteCampaignAssignment())
