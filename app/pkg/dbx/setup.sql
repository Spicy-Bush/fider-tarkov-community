...
INSERT INTO tenants (name, subdomain, created_at, cname, invitation, welcome_message, status, is_private, custom_css, logo_bkey, locale, is_email_auth_allowed, profanity_words, general_settings, message_banner)
VALUES ('Demonstration', 'demo', now(), '', '', '', 1, false, '', '', 'en', true, '', '{"titleLengthMin":15,"titleLengthMax":100,"descriptionLengthMin":150,"descriptionLengthMax":1000,"maxImagesPerPost":3,"maxImagesPerComment":2,"postLimits":{},"commentLimits":{},"postingDisabledFor":[],"commentingDisabledFor":[],"postingGloballyDisabled":false,"commentingGloballyDisabled":false}', '');
...
INSERT INTO tenants (name, subdomain, created_at, cname, invitation, welcome_message, status, is_private, custom_css, logo_bkey, locale, is_email_auth_allowed, profanity_words, general_settings, message_banner)
VALUES ('Avengers', 'avengers', now(), 'feedback.avengers.com', '', '', 1, false, '', '', 'en', true, '', '{"titleLengthMin":15,"titleLengthMax":100,"descriptionLengthMin":150,"descriptionLengthMax":1000,"maxImagesPerPost":3,"maxImagesPerComment":2,"postLimits":{},"commentLimits":{},"postingDisabledFor":[],"commentingDisabledFor":[],"postingGloballyDisabled":false,"commentingGloballyDisabled":false}', '');
...
INSERT INTO tenants (name, subdomain, created_at, cname, invitation, welcome_message, status, is_private, custom_css, logo_bkey, locale, is_email_auth_allowed, profanity_words, general_settings, message_banner)
VALUES ('Trial Expired', 'trial-expired', now(), 'feedback.trial-expired.com', '', '', 1, false, '', '', 'en', true, '', '{"titleLengthMin":15,"titleLengthMax":100,"descriptionLengthMin":150,"descriptionLengthMax":1000,"maxImagesPerPost":3,"maxImagesPerComment":2,"postLimits":{},"commentLimits":{},"postingDisabledFor":[],"commentingDisabledFor":[],"postingGloballyDisabled":false,"commentingGloballyDisabled":false}', '');
