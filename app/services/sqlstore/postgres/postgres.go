...
func (s Service) Init() {
	...
	bus.AddHandler(listSponsorshipPackages)
	bus.AddHandler(getSponsorshipPackageByID)
	bus.AddHandler(createSponsorshipPackage)
	bus.AddHandler(updateSponsorshipPackage)
	bus.AddHandler(deleteSponsorshipPackage)
	bus.AddHandler(listSponsorshipCampaigns)
	bus.AddHandler(getSponsorshipCampaignByID)
	bus.AddHandler(createSponsorshipCampaign)
	...
	bus.AddHandler(updateAdPlacement)
