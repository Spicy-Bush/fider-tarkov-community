      ...
      <VStack spacing={0} className="c-side-menu rounded-md shadow bg-white">
        ...
        {(fider.session.user.isCollaborator) && (
          <>
            ...
            <SideMenuItem name="content" title="Content Settings" href="/admin/content-settings" isActive={activeItem === "content"} />
            <SideMenuItem name="responses" title="Canned Responses" href="/admin/responses" isActive={activeItem === "responses"} />
        ...
        {fider.session.user.isAdministrator && (
          <>
            ...
            <SideMenuItem name="files" title="Files" href="/admin/files" isActive={activeItem === "files"} />
